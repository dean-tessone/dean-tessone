...
I also recently developed a web-based social media for sharing academic papers between researchers called [Quorum](https://www.quorum-papers.com). Basic tech stack: React, Node, Supabase, and a $5 VPS from DigitalOcean. 
